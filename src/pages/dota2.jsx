...
const Dota2 = () => {
  return (
    <div className="min-h-[88vh] bg-[#0f1218] text-white flex flex-col items-center py-6 px-4">
      <h1 className="text-4xl font-bold mb-6">DOTA 2 TOURNAMENTS</h1>
      ...
      <div className="w-[90%] max-w-[1440px] min-h-[calc(100vh-12vh-2rem)] bg-[#1a1f2b] flex gap-8 p-8 rounded-xl">
        ...
        <div className="flex flex-col gap-8 flex-[3]">
          ...
          <div className="bg-[#232a38] p-4 rounded-lg">
            ...
            <div className="mb-4">
              <img src="/dota2_images/news1.png" alt="Dota 2 News" className="rounded-md w-full" />
              <h3 className="text-lg font-bold mt-2">New Hero Incoming</h3>
              <p>Valve teases a new hero arriving this season.</p>
            </div>
            <div>
              <img src="/dota2_images/news2.png" alt="Dota 2 News" className="rounded-md w-full" />
              <h3 className="text-lg font-bold mt-2">Battle Pass Released</h3>
              <p>Get rewards and levels in the new BP event.</p>
            </div>
          </div>
          ...
          <div className="bg-[#232a38] p-4 rounded-lg">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              {[
                { name: 'DotaGod', viewers: '8.3K', img: '/dota2_images/stream1.png' },
                { name: 'InvokerPro', viewers: '6.1K', img: '/dota2_images/stream2.png' },
                { name: 'RoshanHunter', viewers: '2.7K', img: '/dota2_images/stream3.png' }
              ].map((streamer, idx) => (
          ...
          <div className="bg-[#232a38] p-4 rounded-lg">
            ...
            <p>7.36 patch is expected in early May.</p>
          </div>
        </div>
        ...
        <div className="bg-[#232a38] p-4 rounded-lg flex-[1] flex flex-col gap-4 sticky top-[4vh] self-start h-fit hidden md:flex">
          ...
          {['Dota Champions League', 'Dota Cup', 'The Ancient Clash', 'Summer Invitational'].map((name, idx) => (
